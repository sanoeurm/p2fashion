...
class ControllerModulePavmegamenu extends Controller {
	...
	public function liveedit(){
		...
		$this->document->addStyle(  HTTPS_CATALOG.'catalog/view/theme/'.$theme.'/stylesheet/bootstrap.css');
		$this->document->addScript( HTTPS_CATALOG.'catalog/view/javascript/jquery/bootstrap/bootstrap.js');
		$this->document->addScript( 'view/javascript/pavmegamenu/editor.js');
		
		$this->document->addStyle(  HTTPS_CATALOG.'catalog/view/theme/'.$theme.'/stylesheet/font-awesome.min.css');
