...
<div id="content">
  ...
  <div class="box">
    ...
    <table class="form">
      <tr>
        <td><?php echo $this->language->get('entry_prefix_class'); ?></td>
        <td class="left"><input type="text" name="pavproducts_module[<?php echo $module_row; ?>][prefix_class]" value="<?php echo isset($module['prefix_class'])?$module['prefix_class']:''; ?>"/></td> 
      </tr>
			<tr>
...
function addModule() {	
    ...
    html += '    <tr>';
  html += '      <td><?php echo $this->language->get("entry_prefix_class"); ?></td>';
  html += '    <td class="left"><input type="text" name="pavproducts_module[' + module_row + '][prefix_class]" value=""/></td>';
  html += '    <tr>';
