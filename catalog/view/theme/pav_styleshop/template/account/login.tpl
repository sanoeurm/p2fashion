...
<?php $themeConfig = (array)$this->config->get('themecontrol'); ?>
<div class="container">
<div class="row">
				...
				<div class="col-lg-6 col-sm-6 col-xs-12">
					<div class="inner no-margin">
						...
						<div class="content">
							...
							<a href="<?php echo $register; ?>" class="button btn btn-theme-default"><?php echo $text_register; ?></a>
						</div>
					</div>
				</div>
			</div>	
